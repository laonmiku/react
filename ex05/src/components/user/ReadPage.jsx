...
import ReadUidOver from './ReadUidOver';
const ReadPage = () => {
          ...
          <Card.Body>
              <Row className='mb-3'>
                <Col md={3} className='align-items-center my-3 text-center'>
                    ...
                    <Button onClick={onUploadImage} className='w-100 mt-1 border border-1'variant='light' size='sm'>이미지저장</Button>    
                    <PassModal  />
                </Col> 
                <Col>
                  ...
                  <InputGroup className='mb-2'>
                    <InputGroup.Text  className='w-25 justify-content-center'> 이름</InputGroup.Text>
                    <Form.Control name="uname" onChange={onChangeForm} value={uname}/>
                  </InputGroup>
                  <InputGroup className='mb-2'>
                    <InputGroup.Text  className='w-25 justify-content-center'>전화</InputGroup.Text>
                    <Form.Control name="phone" onChange={onChangeForm} value={phone}/>
                  </InputGroup>
                  <InputGroup className='mb-2'>
                    <InputGroup.Text  className='w-25 justify-content-center'>주소</InputGroup.Text>
                    <Form.Control name="address1" onChange={onChangeForm} value={address1} placeholder='상세주소'/>
                  ...
                  <div className='text-center mt-3'>
                    <Button onClick={onInsert}
                      className='me-2 border border-1' variant='light'>정보수정</Button>
                    <Button variant='white' className='border border-1'>수정취소</Button>
                  </div>
                </Col>
              </Row>
          </Card.Body>
